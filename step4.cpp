...
int main() {
    ...
    int32_t* shirota = (int32_t*)malloc(pointNum * sizeof(int32_t));

    // 2. ПРОВЕРКА ОБЕИХ ОБЛАСТЕЙ ПАМЯТИ (Защита от сбоя)
    if (altitudes == NULL || longtitude == NULL || shirota == NULL) {
